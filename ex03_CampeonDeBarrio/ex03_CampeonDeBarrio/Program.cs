...
namespace ex03_CampeonDeBarrio
{
    public class Program
    {
        ...
        {      
            Console.WriteLine("*** Campeón Barrio *** \n\n");
        ...
        public static int IdentificaCampeon(Jugador[] arregloJugadores)
        {
            ...
            //
            string[] arregloCampeones = new string[cantidadCampeones];
            int numeroCampeones = 0;
            ...
            if (cantidadCampeones == 1)
            {
               ...
               // $" que obtuvo promedio de {jugadorCampeon.Promedio.ToString("0.00")} puntos por campaña.");
                arregloCampeones[0] = jugadorCampeon.Nombre;
            }
            else
            {
                ...
                foreach (Jugador unJugador in arregloJugadores)
                {
                    if (unJugador.Promedio == jugadorCampeon.Promedio) 
                    {
                        arregloCampeones[numeroCampeones] = unJugador.Nombre;
                        numeroCampeones++;
